...
const Home = () => {
  ...
  const upcomingTasks = [
    { id: 1, title: "Math Assignment: Algebra", due: "Today", subject: "Mathematics", color: "bg-pink-100 text-pink-600" },
    { id: 2, title: "Read Chapter 5: Cell Biology", due: "Tomorrow", subject: "Biology", color: "bg-green-100 text-green-600" },
    { id: 3, title: "Practice Essay Writing", due: "Thu, Apr 10", subject: "English", color: "bg-blue-100 text-blue-600" }
  ];
  ...
  const navItems = [
    ...
    { icon: <Bookmark className="h-5 w-5" />, name: "Subjects", path: "/subjects" },
    { icon: <Calendar className="h-5 w-5" />, name: "Calendar", path: "/calendar" },
    { icon: <BarChart2 className="h-5 w-5" />, name: "Progress", path: "/progress" },
    { icon: <Brain className="h-5 w-5" />, name: "AI Assistant", path: "/assistant" },
  ];

  // Secondary navigation items
  const secondaryNavItems = [
    { icon: <Settings className="h-5 w-5" />, name: "Settings", path: "/settings" },
    { icon: <HelpCircle className="h-5 w-5" />, name: "Help & Support", path: "/help" },
  ];
              ...
              <ul className="space-y-1 px-3">
                {secondaryNavItems.map((item) => (
                  <li key={item.name}>
                    ...
                    >
                      <div className={`${sidebarCollapsed ? 'mx-auto' : 'mr-3'} text-gray-500`}>
                        {item.icon}
                      </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="opacity-90 mt-1">Ready for a productive {timeOfDay}?</p>
                  </div>
                </div>
              ...
              <Card className="mb-8 border-0 shadow-md bg-gradient-to-r from-purple-50 to-blue-50">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                    <div>
                      <h2 className="text-xl font-semibold mb-2">Welcome to EduGuide</h2>
                      <p className="text-gray-600 mb-4">Here's how to make the most of your learning journey:</p>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h3 className="font-medium text-gray-800">Track Study Time</h3>
                            <p className="text-sm text-gray-600">Our focus monitoring helps you build better habits</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h3 className="font-medium text-gray-800">Complete Tasks</h3>
                            <p className="text-sm text-gray-600">Organized by subject to keep you on track</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h3 className="font-medium text-gray-800">Ask AI for Help</h3>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Link to="/tasks" className="text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center">
                  ...
                  <div className="space-y-3">
                    {upcomingTasks.map(task => (
                      <Card key={task.id} className="border border-gray-200 hover:border-indigo-300 transition-colors">
                        <CardContent className="p-4">
                          <div className="flex justify-between items-center">
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <span className={`text-xs px-2 py-0.5 rounded-full ${task.color}`}>
                                  {task.subject}
                                </span>
                ...
                <section>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Link to="/subjects" className="text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center">
                      ...
                      >
                        <Link to={`/subject/Layout`}>
                          <CardContent className="p-4">
                            ...
                            <h3 className="font-medium group-hover:text-indigo-600 transition-colors">{subject.name}</h3>
                            <p className="text-sm text-gray-500 mt-1">
                              {subject.taskCount || Math.floor(Math.random() * 5) + 1} tasks
                            </p>
                          </CardContent>
                        </Link>
                      </Card>
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">{studyStats.weeklyMinutes} mins</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">{studyStats.completedTasks}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">{studyStats.streakDays} days</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-3 items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Linear equations</p>
                        </div>
                      </div>
